...
* Support cruiser: cost ![~~](adjust.png), repair rate ![↑↑](buff.png), AA ![↓↓](nerf.png), population cost ![↑↑](buff.png)
* Production cruiser: cost ![↓↓](nerf.png), Refinery tech ![~~](adjust.png)
* Strike craft:
...
* Baserunners: cost ![↓↓](nerf.png)![↓↓](nerf.png), AA ![↑↑](buff.png)![↑↑](buff.png)
